...
def makeLikelihoodPlot(filename,pdgid,canvas,savename,title=""):
  f = root.TFile(filename)
  histStr = "dEdxAllTracks/TruePDG"+str(pdgid)+"plane12D"
  hist = f.Get(histStr)
...
makeLikelihoodPlot("isoInTPC/isoInTPC_pip_v3_dEdxAllTracks.root",211,canvas,"LH_iso_pip.png","Likelihood for isotropic, evenly-distributed #pi^{+}")
makeLikelihoodPlot("isoInTPC/isoInTPC_p_v3_dEdxAllTracks.root",2212,canvas,"LH_iso_p.png","Likelihood for isotropic, evenly-distributed p")
makeLikelihoodPlot("isoInTPC/isoInTPC_kp_v3_dEdxAllTracks.root",321,canvas,"LH_iso_kp.png","Likelihood for isotropic, evenly-distributed K^{+}")
makeLikelihoodPlot("isoInTPC/isoInTPC_mup_v3_dEdxAllTracks.root",-13,canvas,"LH_iso_mup.png","Likelihood for isotropic, evenly-distributed #mu^{+}")
makeLikelihoodPlot("isoInTPC/isoInTPC_e_v3_dEdxAllTracks.root",11,canvas,"LH_iso_e.png","Likelihood for isotropic, evenly-distributed e^{-}")
